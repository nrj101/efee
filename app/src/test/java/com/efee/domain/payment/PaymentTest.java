...
class PaymentTest {
    ...
    @Test
    void shouldRejectRealisingAlreadyCancelledPayment() {
        Payment payment = new Payment(
                "PAY-001", "PAYER-001",
                new BigDecimal("1000.00"), "CREDIT_CARD", "REF-001");
        payment.cancel();
    ...
    @Test
    void shouldRejectCancellingAlreadyCancelledPayment() {
        Payment payment = new Payment(
                "PAY-001", "PAYER-001",
                new BigDecimal("1000.00"), "CREDIT_CARD", "REF-001");
        payment.cancel();
    ...
    @Test
    void shouldRejectCancellingAlreadyRealisedPayment() {
        Payment payment = new Payment(
                "PAY-001", "PAYER-001",
                new BigDecimal("1000.00"), "CREDIT_CARD", "REF-001");
        payment.realise();
    ...
    void shouldCreatePaymentWithoutReference() {
        Payment payment = new Payment(
                "PAY-001", "PAYER-001",
                new BigDecimal("1000.00"), "CREDIT_CARD", null);

        assertNull(payment.getPaymentReference());
        assertEquals(PaymentLifecycle.RECORDED,
